//
//  NewsListBigTableViewCellTests.swift
//  NewsTests
//
...
final class NewsListBigTableViewCellTests: XCTestCase {

    var cell: NewsListBigTableViewCell!
    ...
    override func setUp() {
        ...
        let nib = NewsListBigTableViewCell.nib()
        cell = nib.instantiate(withOwner: nil, options: nil).first as? NewsListBigTableViewCell
